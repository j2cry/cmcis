...
class TGText:
    ...
    ZERO_PUBLIC_EVENTS = f'На данный момент новых мероприятий не анонсировано. Подписывайтесь и следите за новостями в [основном канале]({LINK}).'
    ...
    NOTIFICATION = 'Привет! Вы записаны на мероприятие %s, которое начнется %s на территории "Ковчега" в Ереване.\nАдрес: ул. Павтоса Бузанда, 1/3.\n'\
                   'Вход со стороны ул. Бузанда, в центре здания широкие ступеньки, вход сразу слева, синяя вывеска "Ковчег", дверь с решеткой.\n'\
